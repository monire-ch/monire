...
before: |
  Expenses were tracked manually. Receipts arrived by email and post. Each receipt had to be:
...
after: |
  ...
  • Files are renamed and stored in the correct OneDrive month folder.
